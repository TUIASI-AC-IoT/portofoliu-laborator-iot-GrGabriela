...
#define CONFIG_EXAMPLE_FIRMWARE_UPGRADE_URL "https://192.168.245.213:5000/firmware.bin"
#define VERSION_DATA "https://192.168.245.213:5000/version" 
...
void app_main(void)
{
    ...
    if (connected) {
        ...
        xTaskCreate(http_rest_with_url, "version_task", 100, NULL, 5, NULL);
    }
}